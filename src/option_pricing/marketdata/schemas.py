...
CLEANED_QUOTES_COLUMNS = (
    ...
    "option_price_for_model",
    "mid_computed",
    "time_to_expiry_computed",
    "moneyness_computed",
    "provider_iv_available",
    "provider_greeks_available",
    "model_price_available",
    "model_validation_ready",
    "iv_validation_ready",
...
CLEANED_QUOTES_DTYPES: dict[str, PandasSchemaDtype] = {
    ...
    "option_price_for_model": "Float64",
    "mid_computed": "boolean",
    "time_to_expiry_computed": "boolean",
    "moneyness_computed": "boolean",
    "provider_iv_available": "boolean",
    "provider_greeks_available": "boolean",
    "model_price_available": "boolean",
    "model_validation_ready": "boolean",
    "iv_validation_ready": "boolean",
    "greek_validation_ready": "boolean",
    "source": "string",
