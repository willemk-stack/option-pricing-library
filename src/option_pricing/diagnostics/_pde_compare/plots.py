...
def plot_error_vs_runtime(
    ...
    *,
    ...
    logy: bool = True,
    figsize=(7, 4),
    title: str = "PDE vs Analytic: error vs runtime",
):
    """Scatter plot of error vs runtime."""
...
def plot_convergence(
    ...
    *,
    ...
    """Convergence plot of y_col vs x_col, optionally grouped."""
    ...
    ax.set_xlabel(x_col)
    ax.set_ylabel(y_col)
    ax.set_title(title or f"Convergence: {y_col} vs {x_col}")
    pretty_ax(ax)
    return fig, ax
...
def plot_price_scatter(
    ...
    *,
    ...
    y_col: str = "pde",
    figsize=(5, 5),
    title: str = "PDE vs Analytic: price scatter",
):
    """Scatter of PDE prices against analytic benchmark."""
    require_columns(df, [x_col, y_col])
