...
- The brownian motion has no tendency to go up or down, see def 3, the Exp val of W(s) at time
t = s is W(s). This is not to say that Brownian motion will always converge to 0 but if it attains W(s) the Exp val of W(s) at time t = s is W(s)
